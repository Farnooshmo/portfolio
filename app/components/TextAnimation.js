...
export default function AnimatedText() {
  ...
  return (
    <div className="text-container relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-violet-00  font-mono text-center text-xl font-extrabold">
      <span
