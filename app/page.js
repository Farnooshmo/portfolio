  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-gradient-to-tr from-zinc-500  via-teal-1000 via-10% to-zinc-950 to-60% text-red-50 ">
      <div>
        ...
        <p className=" grid whitespace-normal mb-8 text-base">
          ...
          education and administration. However, my true passion lies in the
          world of Web Development. Recently, I have decided to take on the
          exciting challenge of changing my career path by enrolling in an
          intensive course that covers both front-end and back-end aspects of
          web development. Through this comprehensive course, I have honed my
          skills and completed successful projects, gaining a sharp eye for
          detail and a creative mindset that make me a valuable asset to any
          team. I am now eager to apply my knowledge and expertise
          professionally and contribute to the dynamic and ever-evolving world
          of web development.{" "}
        </p>
      </div>
      <section></section>
